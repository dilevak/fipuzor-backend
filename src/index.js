...
const allowedOrigins = ['http://localhost:8080', 'http://192.168.8.108:8080', '192.168.8.0/24', 'https://zesty-cactus-ad775e.netlify.app']; //dodavanje jos origina po potrebi
app.use(cors({
